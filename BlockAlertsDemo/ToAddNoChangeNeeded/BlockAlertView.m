...
- (void)addButtonWithTitle:(NSString *)title type:(NSString*)color block:(void (^)())block 
{
...
{
  [self addButtonWithTitle:title type:@"button" block:block];
}

- (void)setCancelButtonWithTitle:(NSString *)title block:(void (^)())block 
{
  [self addButtonWithTitle:title type:@"cancelButton" block:block];
}

- (void)setDestructiveButtonWithTitle:(NSString *)title block:(void (^)())block
{
  [self addButtonWithTitle:title type:@"destructiveButton" block:block];
}
